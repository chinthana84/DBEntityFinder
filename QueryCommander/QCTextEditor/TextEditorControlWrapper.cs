...
namespace QueryCommander.Editor
{
	...
	public class TextEditorControlWrapper:TextEditorControl
	{
		...
		public void SetPosition(int pos)
		{
			...
			int diff=pos-this.ActiveTextAreaControl.Caret.Offset;

			textArea.Caret.Column+=diff;
		...
		private void ttt()
		{
			...
			System.IO.Stream file = thisExe.GetManifestResourceStream("QueryCommander.Database.Embedded.SQL-Mode.xshd");
			XmlDocument xmlReservedWords = new XmlDocument();
			xmlReservedWords.Load(file);
			XmlNodeList keyWordsNodes = xmlReservedWords.GetElementsByTagName("KeyWords");
