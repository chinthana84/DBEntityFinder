...
//		FontStyle		_fontStyle	= FontStyle.Regular;
		...
		private void LoadXMLDocuments()
		{
			...
			System.IO.Stream file = thisExe.GetManifestResourceStream("QueryCommander.QCTextEditor.SQLReservedWords.xml");
			...
			string filename = System.IO.Path.Combine(strWorkPath, "EditorSettings.config");
