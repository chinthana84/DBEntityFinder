...
namespace QueryCommander
{
	...
	public class FrmWorkSpace :  FrmBaseContent
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.menuItemAddActiveDocument.Index = 4;
			...
			// 
			this.menuItemAddAllDocuments.Index = 5;
			...
			// 
			this.menuItemAddScriptFile.Index = 6;
			...
			// 
			this.menuItemOpenDocument.Index = 7;
			...
			// menuItemDeleteItem
			// 
			this.menuItemDeleteItem.Index = 8;
