...
namespace QueryCommander.WinGui.UserControls
{
	...
	public class UcDbConnectionMicrosoftSqlClient : System.Windows.Forms.UserControl
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(UcDbConnectionMicrosoftSqlClient));
			...
			this.label2.Text = "The Microsoft Sql Data Provider is specific to Microsoft SQL Server. Because it d" +
				"oes not have to go through an OLE DB layer, it is faster than the OleDb Data Pro" +
				"vider. However, it can only be used with SQL Server 7.0 or later. ";
			// 
			// label3
			// 
		...
		public DataSource GetDataSource()
		{
			...
			dataSource.ConnectionType=DataSource.DBConnectionType.MicrosoftSqlClient;
